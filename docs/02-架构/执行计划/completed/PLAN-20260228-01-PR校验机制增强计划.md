...
| WI-PLAN2026022701-10 | capability | PR 校验鲁棒性增强 | repo-owner | done | `scripts/cap/verify.sh CAP-010` | `artifacts/CAP-010/` |
| WI-PLAN2026022701-11 | debt | 工程智能化能力缺口落地（PR 相关子域） | repo-owner | in_progress | `scripts/workflow/run.sh WI-PLAN2026022701-11 progress` | `artifacts/workflow/` |

## 推进记录

| 日期 | WorkItem | 动作 | 结果 | 备注 |
|---|---|---|---|---|
| 2026-02-28 | WI-PLAN2026022701-10 | `scripts/ci/gate-selftest.sh` | pass | 补齐正反例自测 |
| 2026-02-28 | WI-PLAN2026022701-10 | push diff 回退增强 | pass | before SHA 不可达时回退 merge-base |
| 2026-02-28 | WI-PLAN2026022701-09 | 模板与指路信息收敛 | pass | PR 模板与 CI 指路统一 |
